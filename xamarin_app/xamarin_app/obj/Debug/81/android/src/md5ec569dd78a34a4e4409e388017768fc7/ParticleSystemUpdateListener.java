package md5ec569dd78a34a4e4409e388017768fc7;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NL.DionSegijn.Konfetti.Listeners.ParticleSystemUpdateListener, DanielMartinusKonfetti", ParticleSystemUpdateListener.class, __md_methods);
	}
	...
	public ParticleSystemUpdateListener ()
	{
		...
		if (getClass () == ParticleSystemUpdateListener.class)
			mono.android.TypeManager.Activate ("NL.DionSegijn.Konfetti.Listeners.ParticleSystemUpdateListener, DanielMartinusKonfetti", "", this, new java.lang.Object[] {  });
	}
